$(document).ready(function() {
    console.log("JSON PRACTICE PAGE");
    const googleBook = {
        ...
        $('#title').text(googleBook.title)
        $('#author').text(googleBook.authors[0].key)
        $('#date').text(googleBook.publish_date)
        $('#publisher').text(googleBook.publishers)
        $('#first').text(googleBook.first_sentence.value)
